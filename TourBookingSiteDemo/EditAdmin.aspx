<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditAdmin.aspx.cs" Inherits="TourBookingSiteDemo.EditAdmin" %>
...
&nbsp;<asp:TextBox ID="admin_name" runat="server"  class="form-control"  aria-describedby="emailHelp"></asp:TextBox>
  ...
  <asp:Button ID="add" runat="server" Text="Edit" type="submit" class="btn btn-primary" Width="96px"></asp:Button>
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <asp:Button ID="clear" runat="server" Text="Clear" class="btn btn-danger" Width="95px" CausesValidation="False"/>
