<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteGallery.aspx.cs" Inherits="TourBookingSiteDemo.DeleteGallery" %>
...
&nbsp;<asp:TextBox ID="price" runat="server"  class="form-control"  aria-describedby="emailHelp" ReadOnly="true"></asp:TextBox>
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <asp:Button ID="gallery_clear" runat="server" Text="Delete" class="btn btn-danger" Width="95px" CausesValidation="False"/>
