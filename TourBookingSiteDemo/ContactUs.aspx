<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Tour.Master" CodeBehind="ContactUs.aspx.cs" Inherits="TourBookingSiteDemo.ContactUs" %>
...
<td align="center">
<asp:Button ID="lgbtnlogin" runat="server" Text="Submit" CssClass="btn btn-primary btn-block" Width="500px"/>
</td>
</tr>
<tr>
             
<td align="center">
<asp:Button ID="lgbtnClear" runat="server" Text="Clear" CssClass="btn btn-danger btn-block" Width="500px" Height="49px" CausesValidation="False" UseSubmitBehavior="False"/>
</td>
</tr>
<tr><td align="center">
