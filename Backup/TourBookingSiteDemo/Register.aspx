<%@ Page Title="" Language="C#" MasterPageFile="~/Tour.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="TourBookingSiteDemo.Register" %>
...
<td align="center">
<asp:Button ID="rgbtnregister" runat="server" Text="Register" 
CssClass="btn btn-primary btn-block" Width="500px" 
onclick="rgbtnregister_Click"  />
</td>
</tr>
<tr>
             
<td align="center">
<asp:Button ID="rgbtnClear" runat="server" Text="Clear" 
CssClass="btn btn-danger btn-block" Width="500px" Height="49px" 
UseSubmitBehavior="False" CausesValidation="False" onclick="rgbtnClear_Click" />
</td>
</tr>
<tr>
<td colspan="2" align="center">
<asp:LinkButton ID="login" runat="server"  CausesValidation="False" 
onclick="login_Click"><h4><u>Login Here</u></h4>
</asp:LinkButton>
</td>
</tr>
