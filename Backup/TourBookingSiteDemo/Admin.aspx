<%@ Page Language="C#" AutoEventWireup="true"  CodeBehind="admin.aspx.cs" Inherits="TourBookingSiteDemo.admin" EnableEventValidation="false" %>
...
<td >
    <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("category_img") %>' Height="50px" Width="50px"/></td>
<td><%#Eval("location1") %></td>
<td><%#Eval("location2") %></td
<td><a   href="editcategory.aspx?id=<%#Eval("category_name")%>"  CausesValidation="False">Edit
</a></td>
<td><a href="deletecategory.aspx?name=<%#Eval("category_name") %>"  >Deactive</a></td>
