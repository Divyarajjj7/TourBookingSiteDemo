<%@ Page Title="" Language="C#" MasterPageFile="~/Tour.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TourBookingSiteDemo.Login" %>
...
<td align="center">
<asp:Button ID="lgbtnlogin" runat="server" Text="Login" 
CssClass="btn btn-primary btn-block" Width="500px" onclick="lgbtnlogin_Click" />
</td>
</tr>
<tr>
             
<td align="center">
<asp:Button ID="lgbtnClear" runat="server" Text="Clear" 
CssClass="btn btn-danger btn-block" Width="500px" Height="49px" 
CausesValidation="False" UseSubmitBehavior="False" onclick="lgbtnClear_Click" />
</td>
</tr>
<tr>
<td colspan="2" align="center">
<asp:LinkButton ID="reglink" runat="server" CausesValidation="False" 
onclick="reglink_Click"><h4><u>Register Here</u></h4></asp:LinkButton>
</td>
</tr>
